...
While assignments are usually due on Thursdaysbefore class (check CANVAS), please read the following:

1.  On Thursdays, I will stay past the end of the class in the classroom, in case you have any questions.
2.  My office is in room 474 of the ANR building.
...
If you are using projects (recommended) you can skip this section!
...
## If you are using projects (you should be doing this!)
...
Or to create an HTML file if you want it to look like mine:
...
1.  Create a new Quarto file (html, PDF or Word). This is the file that you will upload to Canvas.Save it in the project folder.
2.  Write an answer to the following question: why is study design important in Fisheries
