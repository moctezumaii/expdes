...
As I mentioned before, moving forward I will provide less and less code. However, we will work on some of this code next week. You have 2 weeks for this assignment
...
We will go through the Poisson example in class. You can also download the presentation file (from Canvas) and access all of the code we used. During this assignment we will focus on the following:
