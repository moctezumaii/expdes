...
```{r diagnostics-biomass-linear, fig.width=8, fig.height=4}
par(mfrow = c(1, 2))
...
```{r plot-biomass-linear, fig.width=7, fig.height=5}
...
```{r diagnostics-biomass-quadratic, fig.width=8, fig.height=4}
par(mfrow = c(1, 1))
...
```{r plot-seedling-linear, fig.width=7, fig.height=5, output = TRUE}
...
```{r diagnostics-seedling-linear, fig.width=7, fig.height=5}
plot(
