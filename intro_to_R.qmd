---
title: "Intro to R, Projects, and Quarto"
...
Introduction to R, Projects, and Quarto. This is an assignment that I use for all the classes in which I teach/use R. I apologize if you have experience with R. In this course we will focus on experimental design, data analysis, and program R will be a bit of a secondary learning objective.

::: callout-important
## About assignments

1.  My office is in room 474 of the ANR building. I am happy to help you with any assignment questions. Please don't hesitate to stop by my office!
2.  I am ALWAYS available via email, and I will do my best effort to reply to any R questions about the assignments as soon as possible. Please don't hesitate to reach me.
3.  Most of the assignments will have the following structure: half-tutorial, and then half questions and assignment. You only need to turn things in that actually say "assignment question". As we move on, there will be less and less tips and less "tutorials" and more questions.
:::

This assignment is more of a tutorial than a typical assignment. All questions are at the end.
...
We won't have much time to go over probability distributions. If you are unfamiliar with them, you should read: 🔗[An Intuitive, Interactive, Introduction to Biostatistics by Caitlin Ward and Collin Nolte](#0)*🔗* . It is a great online stats book. It will be helpful for the semester!
...
```{r eval=FALSE}
read.csv('C:/Users/amolina6/Documents/projects/ANSC571/ButterflyData.csv')
```
...
```{r eval=FALSE}
read.csv('~/ANSC571/ButterflyData.csv')
```

IF WINDOWS:

```{r eval=FALSE}
read.csv('C:/Users/YourUserID/ANSC571/ButterflyData.csv')
```
